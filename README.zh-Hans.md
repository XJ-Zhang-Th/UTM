...
如果您只是想使用UTM，请访问https://getutm.app/install/ 来获取相关教程.
...
如果使用Xcode进行构建，则会自动完成签名。由于iOS签名的错误导致不支持iOS 13.3.1。您可以使用低于或高于13.3.1的任何版本。
...
如果你有一台越狱设备，你也可以伪造签名(安装了“ldid”插件):
...
苹果不允许大部分解释或生成代码的应用程序在App Store中上架，因此UTM几乎没有可能被允许上架。然而，人们在互联网上有各种各样的方式来获得不需要越狱就能下载并安装的应用程序。我们支持这些方法中的任何一种。
